...
Extract from [kubernetes.io](https://kubernetes.io/docs/concepts/configuration/secret/) about Secrets:
...
Extract from [kubernetes.io](https://kubernetes.io/docs/concepts/configuration/secret/):
...
Extract of [wikipedia.org](https://en.wikipedia.org/wiki/Key_management):
...
Extract of [wikipedia.org](https://en.wikipedia.org/wiki/Zero_trust_security_model):
